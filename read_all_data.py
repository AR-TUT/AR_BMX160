'''!
  File Name         : read_all_data.py
  File Operation    : Get All Data of Accelerometer, Gyroscope, and Magnatometer 
  |                   And the respective changes are displayed 
  Copyright	        : Open to All
  Author Name       : Arumugaraja @ AR  
